...
export class ResetPasswordControllers {
 ...
 async reset(req: Request, res: Response) {
  ...
  const getResetEntry1 = await models.findResetByToken(process.env.DB_TABLE2, token);
  ...
  const getResetEntry2 = await models.findResetByEmail(process.env.DB_TABLE2, getResetEntry1.email);
  ...
  await models.updatePasswordByEmail(process.env.DB_TABLE1, getUserEmail, password);  
